...
DroidMemory &DroidMemory::operator+(DroidMemory &droidMemory)
{
    DroidMemory *currentDroidMemory = new DroidMemory();
    currentDroidMemory->_exp += droidMemory.getExp();
    currentDroidMemory->_fingerprint ^= droidMemory.getExp();
    return *currentDroidMemory;
}
...
bool DroidMemory::operator==(DroidMemory &droidMemory)
{
