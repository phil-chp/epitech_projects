...
class MissionCriticalError : public NasaError {
    public:
        MissionCriticalError(const std::string &message, const std::string &component = "Unknown");
};

class LifeCriticalError : public NasaError {
    public:
        LifeCriticalError(const std::string &message, const std::string &component = "Unknown");
};
