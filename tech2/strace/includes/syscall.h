...
typedef struct syscall_s {
    short const  id;
    char  const *name;
    short const  arg_count;
    int   const  ret_value;
    int   const  arg_type[6];
} syscall_t;
...
static syscall_t table[330] = {
    ...
    {23, "select", 5, NUM, NUM, FD_SET_P, FD_SET_P, FD_SET_P,   \
        STRUCT_TIMEVAL_P, 0},
    ...
    {35, "nanosleep", 2, NUM, CONST_STRUCT_TIMESPEC_P, STRUCT_TIMESPEC_P, 0,   \
        0, 0, 0},
    ...
    {210, "io_cancel", 3, NUM, AIO_CONTEXT_T, STRUCT_IOCB_P,    \
    ...
    {217, "getdents64", 3, NUM, UNSIGNED, STRUCT_LINUX_DIRENT64_P, UNSIGNED,   \
        0, 0, 0},
    ...
    {222, "timer_create", 3, NUM, CLOCKID_T, STRUCT_SIGEVENT_P, TIMER_T_P, 0,  \
        0, 0},
    ...
    {227, "clock_settime", 2, NUM, CLOCKID_T, CONST_STRUCT_TIMESPEC_P, 0, 0,   \
        0, 0},
    ...
    {248, "add_key", 5, KEY_SERIAL_T, STRING, STRING, CONST_VOID_P, NUM,    \
        KEY_SERIAL_T, 0},
    {249, "request_key", 4, KEY_SERIAL_T, STRING, STRING, STRING,   \
        KEY_SERIAL_T, 0, 0},
    ...
    {278, "vmsplice", 4, NUM, NUM, CONST_STRUCT_IOVEC_P, UNSIGNED, UNSIGNED,   \
        0, 0},
