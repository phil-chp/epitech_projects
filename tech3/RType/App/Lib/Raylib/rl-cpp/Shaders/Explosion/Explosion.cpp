...
#include "Lib/Raylib/rl-cpp/Shaders/Explosion/Explosion.hpp"
...
rl::Explosion::Explosion(rl::Vector3 cubePos, std::string const &shaderName, rl::Vector4 amp, int maxInstances) : _shader(shaderName)
{
    ...
    CreateLight(LIGHT_DIRECTIONAL, rl::Vector3(50.0f, 50.0f, 0.0f), rl::Vector3(0.0), rl::Color(252, 65, 3, 255), this->_shader);
    // --------------------------------------------------------------------------------------------
