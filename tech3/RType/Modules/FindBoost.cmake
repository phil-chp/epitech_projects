...
if(NOT Boost_INCLUDE_DIRS OR NOT Boost_LIBRARIES)
  ...
  FetchContent_Declare(Boost URL https://sourceforge.net/projects/boost/files/boost/1.80.0/boost_1_80_0.tar.gz)
  ...
  if (NOT Boost_POPULATED)
      ...
      # message(STATUS "SDL2_INCLUDE_DIR: ${sdl2_SOURCE_DIR}")
      set(BUILD_EXAMPLES OFF CACHE BOOL "" FORCE)
      set(Boost_FOUND TRUE)
      set(boost_system_DIR ${boost_SUBBUILD_DIR})
      set(Boost_INCLUDE_DIR ${boost_SOURCE_DIR})
      set(Boost_INCLUDE_DIRS ${boost_SOURCE_DIR})
      set(Boost_LIBRARY ${boost_BINARY_DIR})
      set(Boost_LIBRARIES ${boost_BINARY_DIR})

      message(STATUS "boost_system_DIR: ${boost_system_DIR}")
